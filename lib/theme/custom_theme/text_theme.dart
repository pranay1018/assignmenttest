...
class MyTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    headlineSmall: const TextStyle().copyWith(fontSize: 12.0, fontWeight: FontWeight.bold, color: Colors.black,),
    ...
    titleSmall: const TextStyle().copyWith(fontSize: 14.0, fontWeight: FontWeight.bold, color: Colors.black),
    ...
    bodySmall: const TextStyle().copyWith(fontSize: 10, color: Colors.grey),
